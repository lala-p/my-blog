...
export async function getStaticPaths() {
	// let allNoticeLinkList = noticeData.getAllNoticeNoList().map((noticeNo) => '/notice/' + String(noticeNo))
	...
	return {
		paths: noticeData.getAllNoticeNoList().map((noticeNo) => '/notice/' + String(noticeNo)),
		fallback: false,
	}
}
