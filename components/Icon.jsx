...
export const Icon_Home = (props) => {
	...
	return (
		<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width={props.width ?? '100%'} height={props.height ?? '100%'} viewBox="0 0 24 24" preserveAspectRatio="none">
			<g>
				<path
...
export const Icon_User = (props) => {
	...
	return (
		<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width={props.width ?? '100%'} height={props.height ?? '100%'} viewBox="0 0 24 24" preserveAspectRatio="none">
			<g>
				<path d="M12,12A6,6,0,1,0,6,6,6.006,6.006,0,0,0,12,12ZM12,2A4,4,0,1,1,8,6,4,4,0,0,1,12,2Z" fill={fillColor} />
				<path d="M12,14a9.01,9.01,0,0,0-9,9,1,1,0,0,0,2,0,7,7,0,0,1,14,0,1,1,0,0,0,2,0A9.01,9.01,0,0,0,12,14Z" fill={fillColor} />
			</g>
		</svg>
	)
}
...
export const Icon_DoubleLeft = (props) => {
	...
	return (
		<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width={props.width ?? '100%'} height={props.height ?? '100%'} viewBox="0 0 24 24" preserveAspectRatio="none">
			<g>
				<path d="M12,24a1,1,0,0,1-.71-.29L3.12,15.54a5,5,0,0,1,0-7.08L11.29.29a1,1,0,1,1,1.42,1.42L4.54,9.88a3,3,0,0,0,0,4.24l8.17,8.17a1,1,0,0,1,0,1.42A1,1,0,0,1,12,24Z" fill={fillColor} />
				<path d="M22,24a1,1,0,0,1-.71-.29l-9.58-9.59a3,3,0,0,1,0-4.24L21.29.29a1,1,0,1,1,1.42,1.42l-9.59,9.58a1,1,0,0,0,0,1.42l9.59,9.58a1,1,0,0,1,0,1.42A1,1,0,0,1,22,24Z" fill={fillColor} />
			</g>
		</svg>
	)
}
